              ...
              <div className="absolute left-0 mt-2 w-48 bg-white rounded-xl shadow-lg border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                {allCategorias.map((categoria) => (
                  <button
                    ...
                    onClick={() =>
                      navigate(
                        "/sensores/" + categoria.nombre + "/" + categoria.id
                      )
                    }
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="hidden md:flex items-center space-x-4">
              {user ? (
                ...
                <div className="relative group">
                  <button className="btn-animated bg-secondary-600 px-4 py-2 rounded-full text-base font-medium hover:bg-secondary-700 text-white flex items-center gap-2">
                ...
                {user ? (
                  <div className="px-4 py-2">
                    ...
                    <button
                      ...
                      className="w-full btn-animated bg-secondary-600 text-white py-2 rounded-lg font-medium hover:bg-secondary-700 mb-2 flex items-center justify-center gap-2"
                    >
                      <svg
                        className="w-5 h-5"
                        fill="none"
