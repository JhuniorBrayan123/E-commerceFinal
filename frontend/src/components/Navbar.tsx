              ...
              {user ? (
                <>
                  ...
                  <button
                    ...
                    className="btn-animated bg-secondary-600 text-white px-4 py-2 rounded-full text-base font-medium hover:bg-secondary-700 transition flex items-center gap-2"
                  >
