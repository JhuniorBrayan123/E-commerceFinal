...
# 1. CLASE INLINE: Permite editar los sensores dentro de la Orden
class ItemOrdenInline(admin.TabularInline):
    ...
    fields = ('sensor', 'cantidad', 'precio_unitario', 'get_subtotal') 
...
class OrdenAdmin(admin.ModelAdmin):
    ...
    # C. Aquí se agrega el Inline para ver los sensores
